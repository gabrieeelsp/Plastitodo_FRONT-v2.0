            ...
            <v-col cols="5">
                ...
                <div v-for="(creditnote, index) in sale.relationships.creditnotes" :key="'A' + index">                
                    <div class=" d-flex justify-space-between" >
                        ...
                        <span class="subtitle-1  blue--text darken-4 ml-1">({{ globalHelperFixeDecimalMoney(creditnote.attributes.valor) | money_string }})</span>
                    </div>
                </div >
...
export default {
    ...
    computed: {
        ...mapGetters({
            ...
            totalRefondsSale: 'sales_manager/totalRefondsSale',
        })
    },
